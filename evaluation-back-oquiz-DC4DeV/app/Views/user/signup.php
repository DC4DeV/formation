    ...
    <div class="row">
        <form class="col-md-6 m-auto" method="post" action="">
          <div class="form-group">
            ...
            <input type="text" name="firstname" class="form-control" id="exampleInputFirstname" placeholder="nom d'utilisateur">
          </div>
          <div class="form-group">
            <label for="exampleInputLastname">Nom</label>
            <input type="text" name="lastname" class="form-control" id="exampleInputLastname" placeholder="nom d'utilisateur">
          </div>
          <div class="form-group">
